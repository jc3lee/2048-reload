...
const twitterText =
  "Hello%20world%2C%20I%20had%20the%20bad%20luck%20of%20clicking%20that%20follow%20button%20on%20that%20dude%27s%20account%20and%20now%20I%27m%20playing%20a%20crappy%20game%20to%20not%20hurt%20his%20feelings.";
  ...
  return (
    <main className="w-full h-full flex flex-col">
      <div className="mt-[50px] mx-auto mb-0 w-[310px] topContainer">
        <div className="flex justify-end items-center topContainerTop">
          <h3 className="font-sans text-[2.75rem] mr-auto font-normal text-[#777]title">
            2048
          </h3>
          <div className="font-sans bg-[#bcada1] rounded-[4px] text-white flex flex-col flex-nowrap justify-center items-center py-1 px-2 mr-[10px] scoreBox">
            <p className="text-[0.65rem] tracking-[0.01rem] text-[#dedede]scoreHeaderText">
              SCORE
            </p>
            <p className="text-[1.2rem] score" ref={scoreRef}>
              0
            </p>
          </div>
          <div className="font-sans bg-[#bcada1] rounded-[4px] text-white flex flex-col flex-nowrap justify-center items-center py-1 px-2 highscoreBox">
            ...
            <p className="text-[1.2rem] score" ref={highscoreRef}>
              0
            </p>
          </div>
        </div>
        <div className="flex justify-end items-center py-4 topContainerBtm [&>*]:text-[#eee] [&>*]:w-[35px][&>*]:h-[35px] [&>*]:rounded-[4px] [&>*]:border-none [&>*]:bg-[#bcada1] [&>*]:cursor-pointer [&>*]:flex [&>*]:justify-center [&>*]:items-center">
          <button className="mr-auto share">
            <a
              className="text-[#eee] w-[35px] h-[35px] rounded-[4px] border-none bg-[#bcada1] cursor-pointer flex justify-center items-center"
              href={`https://twitter.com/intent/tweet?text=${twitterText}`}
            >
              <img src="/icons/share.png" alt="share" />
            </a>
          </button>
          <button className="mr-[25px] help" onClick={handleHelp}>
            <img src="/icons/help.png" alt="help" />
          </button>
          <button className="mr-[25px] back" onClick={handleUndo}>
      ...
      <div className="outerContainer">
        ...
        <div className="container">
          ...
          <div ref={helpRef} className="containerHelp" onClick={handleHelp}>
            <ul>
              <li>
                2048 is a game where you combine numbered tiles to make a higher
                numbered tile. You start with two tiles, the lowest possible
                number is two.
              </li>
              <li>
                Move by swiping or using the arrow keys on a PC. Each time you
                move the tiles, another tile pops up ramdomly.
              </li>
              <li>
                By making two tiles with the same number collide on one another
                they will merge into one tile with the sum of the numbers. You
                can undo your last move.
              </li>
              <li>
                The goal is to combine tiles until you get a 2048 tile. After
                winning, you can choose to continue even further.
              </li>
            </ul>
            <p>Tap to continue</p>
          </div>
      ...
      <style jsx global>
        {`
          ...
          .topContainerBtm .help,
          .topContainerBtm .back {
            margin-right: 25px;
          }

          .topContainerBtm .share img,
          .topContainerBtm .help img,
          .topContainerBtm .back img,
          .topContainerBtm .reset img {
            object-fit: contain;
            width: 18px;
            height: 18px;
          }

          .topContainerBtm .share:hover,
          .topContainerBtm .help:hover,
          .topContainerBtm .back:hover,
          .topContainerBtm .reset:hover,
          .topContainerBtm .share:focus,
          .topContainerBtm .back:focus,
          .topContainerBtm .reset:focus {
            opacity: 0.85;
          }
